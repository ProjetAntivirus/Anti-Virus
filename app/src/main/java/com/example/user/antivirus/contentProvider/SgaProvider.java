...
public class SgaProvider extends ContentProvider {
	...
	public Uri insert(Uri uri, ContentValues values) {
        ...
        str.append(SgaContract.SystemCp.CONTENT_URI);
        str.append(" values('");
        str.append(values.get(SgaContract.systemcpColumns.VALUE) + "'");
        str.append(", " + "'"values.get(SgaContract.systemcpColumns.DATE) + "');");
        */
	}
