...
import com.example.user.antivirus.contentProvider.SgaContract.systemcpColumns;
import com.example.user.antivirus.contentProvider.SgaContract.systembdColumns;
...
public class SgaDatabase extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
        ...
        sb.append(systemcpColumns.VALUE).append(" TEXT, ");
        sb.append(systemcpColumns.DATE).append(" TEXT)");
